...
public class MemberController {
    ...
    public String login(MemberVO vo, HttpSession session,RedirectAttributes rattr) {
        int memberCheck = memberService.checkMember(vo);
        MemberVO member = memberService.login(vo);
        if (member != null) {
            session.setAttribute("member", member);
            rattr.addFlashAttribute("member_id", member.getMember_id());
    ...
    public String signUp(MemberVO vo, RedirectAttributes rattr) {
    ...
    public String logout(HttpSession session,RedirectAttributes rattr) {
        rattr.addFlashAttribute("msg", "logout_ok");
        session.invalidate();
        return "redirect:main";
    }
